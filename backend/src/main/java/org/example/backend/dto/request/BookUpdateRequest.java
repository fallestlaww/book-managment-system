...
public class BookUpdateRequest {
    ...
    @Schema(description = "Book title", example = "Gatsby")
    ...
    @Schema(description = "Book author", example = "Scott Fitzgerald")
    private String author;
    
    @Min(0)
    @Schema(description = "Total amount", example = "10")
    private Integer amount;
    
    @Min(0)
    @Schema(description = "Borrowed amount", example = "3")
